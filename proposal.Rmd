...
There exists a [Github database](https://github.com/JeffSackmann/tennis_atp) with all of the matches information, alongside match statistics and player information in CSV form by year. In addition, there is a [page of suspension/doping cases of players](https://en.wikipedia.org/wiki/Doping_in_tennis) that can be webscraped. 
